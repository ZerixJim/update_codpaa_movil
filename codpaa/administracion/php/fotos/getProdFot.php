...
if(isset($_SESSION['usuario']) && isset($_SESSION['permiso'])){
    ...
    $sql = "SELECT concat(p.nombre,' ',p.presentacion,' fotos(',count(pc.idphotoCatalogo),')') as nombre, p.idProducto as idProducto

            FROM photoCatalogo pc
			
			inner join photo_producto pp on (pp.idPhotocatalogo=pc.idphotoCatalogo)
