...
public class Frentes extends Activity implements OnClickListener, OnItemSelectedListener{
	...
	public void onClick(View v) {
		...
		switch(v.getId()) {
		case 1: reQuesFocus(Echa1);break;
		case 2: reQuesFocus(Echa2);break;
		case 3: reQuesFocus(Echa3);break;
		case 4: reQuesFocus(Echa4);break;
		case 5: reQuesFocus(Echa5);break;
		case 6: reQuesFocus(Echa6);break;
