...
require_once 'FotosHelix.php';
require_once '../../clasess/pptCreatorGeneric.php';
...
$datos = FotosHelix::queryFotos($marca, $grupo, $date);
...
if ($arra['success']) {
    ...
    $para = FotosHelix::getMails($grupo);
    $titulo = 'Reporte Helix';
