...
if (isset($_SESSION['usuario']) && isset($_SESSION['permiso'])) {
    ...
    <head>
        ...
        <!--<link rel="stylesheet" href="/assets/css/bootstrap_limitless.min.css" type="text/css">-->
        <!--<link rel="stylesheet" href="/assets/css/bootstrap_limitless.css" type="text/css">-->
        <!--<link rel="stylesheet" href="/assets/css/components.min.css" type="text/css">-->
        <!--<link rel="stylesheet" href="/assets/css/icons/icomoon/styles.min.css" type="text/css">-->
        <!--<link rel="stylesheet" href="/assets/css/components.css" type="text/css">-->
        <!--<link rel="stylesheet" href="/assets/css/layout.min.css" type="text/css">-->
