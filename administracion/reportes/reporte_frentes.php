    ...
    <div id="repor_icenter" data-options="region:'center',title:'Datos',split:true,collapsible:false, fit:true"
        ...
        <div id="ventanaFren" style="height: 95%;">
            ...
            <table id="frentes-datagrid" class="easyui-datagrid" style="width: 100%;" fit="true">
                ...
                <thead>
                <tr>
                    <th data-options="field:'FECHA CAPTURA', sortable:true">fecha</th>
                    <th data-options="field:'ID TIENDA', sortable:true">ID-tienda</th>
                    <th data-options="field:'PROMOTOR', sortable:true">Promotor</th>
                    <th data-options="field:'NIELSEN', sortable:true">Nielsen</th>

                    <th data-options="field:'ID MARCA', sortable:true">ID-Marca</th>
                    <th data-options="field:'GRUPO'">grupo</th>
                    <th data-options="field:'SUCURSAL', sortable:true">sucursal</th>
                    <th data-options="field:'NO. ECONÓMICO'">n.economico</th>
                    <th data-options="field:'FORMATO', sortable:true">formato</th>
                    <th data-options="field:'CADENA', sortable:true">cadenaf</th>
                    <th data-options="field:'ESTADO', sortable:true">estado-mex</th>
                    <th data-options="field:'FRENTES'">frentes</th>
                    <th data-options="field:'ID PRODUCTO'">ID-producto</th>
